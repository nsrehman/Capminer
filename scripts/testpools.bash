...
#
# Testscript to test CapMiner multiple pools/hosts/syntaxes
# Put this script in the bin directory of CapMiner and start running
#
...
# export some vars as "./CapMiner" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./CapMiner -v 1 --exit --report-hashrate -P $pool $@"
    echo "./CapMiner -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./CapMiner -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
