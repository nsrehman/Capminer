# ethash-kernels
For whatever reason, Zawawawa released his Ethash kernels as open source code. This repo is a verbaitm copy of that code with a simplistic build environment and [CapMiner](https://github.com/CapMiner/CapMiner) as a target. Although the code for CapMiner has yet to be released.
